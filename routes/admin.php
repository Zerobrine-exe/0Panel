...
/*
|--------------------------------------------------------------------------
| Webhosting Controller Routes
|--------------------------------------------------------------------------
|
| Endpoint: /admin/webhosting
|
*/
Route::group(['prefix' => 'webhosting'], function () {
    Route::get('/', [Admin\WebhostingController::class, 'index'])->name('admin.webhosting');
    Route::get('/new', [Admin\WebhostingController::class, 'create'])->name('admin.webhosting.new');
    Route::get('/view/{website:id}', [Admin\WebhostingController::class, 'view'])->name('admin.webhosting.view');

    Route::post('/new', [Admin\WebhostingController::class, 'store']);
    Route::post('/view/{website:id}/reprovision', [Admin\WebhostingController::class, 'reprovision'])->name('admin.webhosting.reprovision');
    Route::post('/view/{website:id}/issue-ssl', [Admin\WebhostingController::class, 'issueSsl'])->name('admin.webhosting.issueSsl');
    Route::post('/view/{website:id}/toggle', [Admin\WebhostingController::class, 'toggle'])->name('admin.webhosting.toggle');
});
